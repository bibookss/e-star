    ...
    <div class="col-10 mx-auto">
        <div class="row row-cols-4 row-cols-md-5 gap-5 justify-content-center">
            <a class="btn" href="/viewDorm" role="button">
                <div class="card fw-bold rounded-4 col p-0">
                    <img class="card-img-top img-card" src="assets/image1.jpg" alt="...">
                    <div class="card-body">
                        <h5 class="card-title d-flex fw-bold">Dormitory</h5>
                        <p class="card-text d-flex">
                            <span class="rating-bg mx-1 px-2 py-1 rounded-4 fw-bold text-white">4.5</span>
                            <span class="ps-2">87 reviews</span>
                            <span class="ms-auto">Queborac Drive</span>
                        </p>
                    </div>
                </div>
            </a>
